...
/usr/local/lsws/bin/setup_docker.sh && rm /usr/local/lsws/bin/setup_docker.sh
...
app_wordpress_dl(){
  wp core download --version=5.6.2 --allow-root
}
...
chown 998:998 /usr/local/lsws/conf -R
chown 998:996 /usr/local/lsws/admin/conf -R
